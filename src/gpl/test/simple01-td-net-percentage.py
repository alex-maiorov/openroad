...
design.readDef("./simple01-td-net-percentage.def")
...
def_file = helpers.make_result_file("simple01-td-net-percentage.def")
design.writeDef(def_file)
helpers.diff_files(def_file, "simple01-td-net-percentage.defok")
