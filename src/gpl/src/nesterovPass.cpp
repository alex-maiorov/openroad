...
namespace gpl{
    // TODO: Fix these when later making better infra for gpl
    ...
    //             grad[src_idx] = grad[src_idx] + calculateCellPairwiseGradient(nbc, nbv, src_idx, dest_idx);
    //         }
    //     }
    // }
    //
    ...
    //             grad[cell_idx] = grad[cell_idx] + calculatePinToNetGradient(nbc, nbv, cell_idx, net_idx);
    //         }
    //     }
    //
    // }
