...
FROM hpretl/iic-osic-tools:2025.12 AS final

COPY --from=builder /OpenROAD/build/bin/openroad /foss/tools/bin/openroad
ENV OPENROAD_EXE=/foss/tools/bin/openroad
